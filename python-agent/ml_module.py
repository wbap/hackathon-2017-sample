...
class UmataroComponent(brica1.Component):
    def __init__(self):
        super(UmataroComponent, self).__init__()
        ...
        self.make_in_port('Isocortex.FL-UB-Input', 2)
...
class FLComponent(brica1.Component):
    def __init__(self):
        ...
        # self.make_in_port('Isocortex.ASC-Isocortex.FL-Input', 1)
